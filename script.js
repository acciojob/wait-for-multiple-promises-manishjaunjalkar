...
const promises = [
  new Promise((resolve) => {
    ...
    setTimeout(() => resolve({ name: "Promise no 1", time: time / 1000 }), time);
  }),
  new Promise((resolve) => {
    const time = Math.floor(Math.random() * 3 + 1) * 1000;
    setTimeout(() => resolve({ name: "Promise no 2", time: time / 1000 }), time);
  }),
  new Promise((resolve) => {
    const time = Math.floor(Math.random() * 3 + 1) * 1000;
    setTimeout(() => resolve({ name: "Promise no 3", time: time / 1000 }), time);
  }),
];
